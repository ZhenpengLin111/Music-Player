...
export const useTracks = () => useLibraryStore((state) => state.tracks) // return a list of track with playlist

export const useFavorites = () => {
  // const favorites = useLibraryStore((state) => state.tracks.filter((track) => track.rating === 1)) // computed the favorite tracks
